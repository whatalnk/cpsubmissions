...
# Language: Ruby (2.3.3)
# Submitted: 2017-10-06 12:39:17 +0000 UTC ( https://atcoder.jp/contests/arc027/submissions/1654646 ) 
...
(0...26).to_a.combination(2) do |i, j|
  c1 = @a[i]
  c2 = @a[j]
...
roots = (0...26).select{|i| b[i]}.map{|i| @par[i]}.uniq
