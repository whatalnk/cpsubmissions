...
# Title: A. 山型足し算
# Language: Ruby (2.3.3)
# Submitted: 2018-02-17 09:09:34 +0000 UTC ( https://atcoder.jp/contests/future-contest-2018-qual/submissions/2102555 ) 
...
q = [ret.size, 1000].min
puts q
ret.sort_by{|a| a[2]}.reverse.take(q).each do |l|
  puts l.join(" ")
end